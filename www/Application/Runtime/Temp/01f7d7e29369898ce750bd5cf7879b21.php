<?php
//000000000000s:117927:"<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div id="warpper" class="clearfix">
    ...
    <div class="item fl">
      <div class="fl">
        <span class="u-nav-title">
                      <a href="/index.php/Home/Goods/goodsList/id/19.html">家用电器</a>        </span>
      </div>
  ...
  <div class="cata_cart_left">
    <div class="m-cart">
      <p class="title">
                  <a href="/index.php/Home/Goods/goodsList/id/19.html">家用电器</a>      </p>
      <!--search/?q=-->
      <div id="cata_list">
        <!-- 分类树 -->
        <ul class="menu_3">
          <li class="menu_two">
            ...
            class="selected">电风扇</a></li><li><a  href="/index.php/Home/Goods/goodsList/id/129.html"
            >电话机</a></li>        </ul>
      </div>
  ...
  <div class="searchbox">
    <div class="list clearfix">
      <ul class="left text12" id="order_ul">
        ...
        <li> <a class="col7ac  main" href="/index.php/Home/Goods/goodsList/id/128" style="cursor:pointer;"> 默认 </a> </li>
        <li> <a class="col7ac  " href="/index.php/Home/Goods/goodsList/id/128/sort/sales_sum" style="cursor:pointer;"> 销量 </a> </li>

                	<li><a class="col7ac  " href="/index.php/Home/Goods/goodsList/id/128/sort/shop_price/sort_asc/desc" style="cursor:pointer;">价格<span class="icon_s "></span></a></li>

        <li><a class="col7ac  " href="/index.php/Home/Goods/goodsList/id/128/sort/comment_count" style="cursor:pointer;">评论</a></li>
        <li><a class="col7ac  "  href="/index.php/Home/Goods/goodsList/id/128/sort/is_new" style="cursor:pointer;">新品</a></li>
      </ul>
      <!-- Page -->
